...
} else if (isset($_POST["licensekey"])) {
    try {
        ...
        //adding license to get url
        $url .= "?licensekey=".$_POST["licensekey"]."&host=".$_SERVER['SERVER_NAME'];
...
function _fetchData() {
    ...
    $file_url = $dataDecoded->url."&licensekey=".$_POST["licensekey"];
    $md5 = $dataDecoded->md5;
}
...
<div class="container">
    ...
    <div class="licenseForm">
        <form id="installFormSae" method="post" action="/">
            <input type="hidden" name="sae" value="1">
            <button id="install_button" type="submit">Download &amp; Install SAE</button>
        </form>
        <br />
        <br />
        <form id="installFormCommercial" method="post" action="/">
            <button id="install_commercial_button" type="submit">Download &amp; Install MAE or PE</button>
            <div id="commercial" style="display: none;">
                <input type="text" name="licensekey" value="<?php echo isset($_POST['licensekey']) ? $_POST["licensekey"] : ''?>" placeholder="Please enter your license key" />
                <div class="note_information">
                    <strong>note:</strong> One license token will be consumed for domain: <strong><?php echo $_SERVER["HTTP_HOST"];?></strong>
                </div>
            </div>
        </form>
    </div>
...
<script>
    (function() {
        ...
        var submitCommercialButton = document.getElementById("install_commercial_button");
        var licence = document.getElementById("commercial");
        var loader = document.getElementById("loader");
        var loaderMessage = document.getElementById("loaderMessage");
        var installFormSae = document.getElementById("installFormSae");
        var installFormCommercial = document.getElementById('installFormCommercial');
        ...
        submitButton.addEventListener("click",function(e) {
            ...
            setTimeout(function() {
                installFormSae.submit();
            },100);
        });
        submitCommercialButton.addEventListener("click",function(e) {
            e.stopPropagation();
            e.preventDefault();
